...
#define PWM_SPEED_CIRCLE_LFT 3200
#define RATIO_TURNING_LFT 0.77
#define PWM_SPEED_CIRCLE_RGHT 3200
#define RATIO_TURNING_RGHT 0.77
#define PWM_SPEED_AFTER_GET_PUCK_LEFT 4100
#define PWM_SPEED_AFTER_GET_PUCK_RIGHT 4100
...
// --------------------------------------------------------------
                    ...
                    //calculate_diff_theta(dir_angle,&diff_theta,&bank);
                    //
                    //move_robot_to_puck(bank,diff_theta);
                    //}
                    //
                    //}
                    //else if (status_go_to_goal == 1)
