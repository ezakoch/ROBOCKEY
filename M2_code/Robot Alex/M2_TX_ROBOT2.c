...
#define FIND_PUCK 3
#define GO_TO_GOAL_WITH_PUCK 10
...
#define PWM_SPEED_TURN_LFT 4000//2200
#define PWM_SPEED_TURN_RGHT 4000//2200
...
#define THRESHOLD_PUCK_CENTER_OUTSIDE 0.35
#define THRESHOLD_PUCK_CENTER_INSIDE 0.65
#define	THRESHOLD_PUCK_NOT_FIND 15
            ...
            switch (state)
            {
                ...
                case FIND_PUCK:
                    ...
                    else if (status_go_to_goal == 1)
                    {
                        ...
                        //else if (abs(PT2_left_inside-PT3_right_inside) >= THRESHOLD_PUCK_CENTER_INSIDE*max_pt && abs(PT2_left_inside-PT3_right_inside) < THRESHOLD_PUCK_CENTER_INSIDE2*max_pt) 
						//{
							//if (PT2_left_inside > PT3_right_inside)
							//{
								//turn_left();
