function init_plot_sensors_robot3( src,evnt )

global userdata
    
        % Initialiaze figures
        fig6 = figure(6);
        set(fig6,'Position',[0 0 1200 800])

        subplot(2,3,1)
        hold on
        userdata.ADC.robot3.plot_PT_LO = plot(0,0,'b-');
        userdata.ADC.robot3.plot_PT_RO = plot(0,0,'r-');
        title('Sensors')
        xlabel('Time (sec)')
        ylabel('ADC (0-1023)')
        legend([userdata.ADC.robot3.plot_PT_LO...
                userdata.ADC.robot3.plot_PT_RO],...
        ...
        subplot(2,3,2)
        hold on
        userdata.ADC.robot3.plot_PT_LI = plot(0,0,'b-');
        userdata.ADC.robot3.plot_PT_RI = plot(0,0,'r-');
        userdata.ADC.robot3.plot_PT_PUCK = plot(0,0,'c-');
        title('Sensors')
        xlabel('Time (sec)')
        ylabel('ADC (0-1023)')
        legend([userdata.ADC.robot3.plot_PT_LI...
                userdata.ADC.robot3.plot_PT_RI...
                userdata.ADC.robot3.plot_PT_PUCK],...
        ...
        subplot(2,3,3)
        hold on
        userdata.ADC.robot3.plot_PT_BL = plot(0,0,'b-');
        userdata.ADC.robot3.plot_PT_BR = plot(0,0,'r-');
        title('Sensors')
        xlabel('Time (sec)')
        ylabel('ADC (0-1023)')
        legend([userdata.ADC.robot3.plot_PT_BL...
                userdata.ADC.robot3.plot_PT_BR],...
        ...
        userdata.ADC.robot3.sensors = [LO LI RI RO BL BR PUCK];
        userdata.ADC.robot3.ids = 1:6;
        ...
        h.robot_num = uicontrol('Style', 'text', 'String', 'Robot 3','Fontsize',18,...
        ...
        text_x_value = 60;
        userdata.ADC.robot3.PT_LO_value = uicontrol('Style', 'text', 'String', 'NaN', 'Fontsize',18,...
           'Position', [text_x+text_x_value 8*text_y 80 20], 'BackgroundColor',userdata.defaultBackground);
        userdata.ADC.robot3.PT_LI_value = uicontrol('Style', 'text', 'String', 'NaN', 'Fontsize',18,...
           'Position', [text_x+text_x_value 7*text_y 80 20], 'BackgroundColor',userdata.defaultBackground);
        userdata.ADC.robot3.PT_RI_value = uicontrol('Style', 'text', 'String', 'NaN', 'Fontsize',18,...
           'Position', [text_x+text_x_value 6*text_y 80 20], 'BackgroundColor',userdata.defaultBackground);
        userdata.ADC.robot3.PT_RO_value = uicontrol('Style', 'text', 'String', 'NaN', 'Fontsize',18,...
           'Position', [text_x+text_x_value 5*text_y 80 20], 'BackgroundColor',userdata.defaultBackground);
        userdata.ADC.robot3.PT_BL_value = uicontrol('Style', 'text', 'String', 'NaN', 'Fontsize',18,...
           'Position', [text_x+text_x_value 4*text_y 80 20], 'BackgroundColor',userdata.defaultBackground);
        userdata.ADC.robot3.PT_BR_value = uicontrol('Style', 'text', 'String', 'NaN', 'Fontsize',18,...
           'Position', [text_x+text_x_value 3*text_y 80 20], 'BackgroundColor',userdata.defaultBackground);
        userdata.ADC.robot3.PT_PUCK_value = uicontrol('Style', 'text', 'String', 'NaN', 'Fontsize',18,...
