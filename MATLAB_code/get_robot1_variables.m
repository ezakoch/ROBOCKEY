...
set(userdata.h.robot1.var1_value, 'String',userdata.debugging.status_gtg)

data = fgetl(userdata.handle);
userdata.debugging.dirx = str2double(data);
set(userdata.h.robot1.var2_value, 'String',userdata.debugging.dirx)

data = fgetl(userdata.handle);
userdata.debugging.diry = str2double(data);
set(userdata.h.robot1.var3_value, 'String',userdata.debugging.diry)

data = fgetl(userdata.handle);
userdata.debugging.angle_to_goal = str2double(data);
set(userdata.h.robot1.var4_value, 'String',userdata.debugging.angle_to_goal)

data = fgetl(userdata.handle);
userdata.debugging.dist_to_goal = str2double(data);
set(userdata.h.robot1.var5_value, 'String',userdata.debugging.dist_to_goal)
...
set(userdata.h.robot1.var7_value, 'String',userdata.debugging.commands_var(i))

data = fgetl(userdata.handle);
userdata.debugging.diff_theta(i) = str2double(data);
set(userdata.h.robot1.var8_value, 'String',userdata.debugging.diff_theta(i))

data = fgetl(userdata.handle);
userdata.debugging.bank(i) = str2double(data);
set(userdata.h.robot1.var9_value, 'String',userdata.debugging.bank(i))

data = fgetl(userdata.handle);
userdata.debugging.OCR1B(i) = str2double(data);
set(userdata.h.robot1.var10_value, 'String',userdata.debugging.OCR1B(i))

data = fgetl(userdata.handle);
userdata.debugging.OCR1C(i) = str2double(data);
set(userdata.h.robot1.var11_value, 'String',userdata.debugging.OCR1C(i))
