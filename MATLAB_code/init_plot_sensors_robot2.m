function init_plot_sensors_robot2( src,evnt )
...
global userdata
        ...
        userdata.ADC.robot2.sensors = [LO LI RI RO BL BR PUCK];
        userdata.ADC.robot2.ids = 1:6;
        ...
        text_x_value = 60;
        userdata.ADC.robot2.PT_LO_value = uicontrol('Style', 'text', 'String', 'NaN', 'Fontsize',18,...
           'Position', [text_x+text_x_value 8*text_y 80 20], 'BackgroundColor',userdata.defaultBackground);
        userdata.ADC.robot2.PT_LI_value = uicontrol('Style', 'text', 'String', 'NaN', 'Fontsize',18,...
           'Position', [text_x+text_x_value 7*text_y 80 20], 'BackgroundColor',userdata.defaultBackground);
        userdata.ADC.robot2.PT_RI_value = uicontrol('Style', 'text', 'String', 'NaN', 'Fontsize',18,...
           'Position', [text_x+text_x_value 6*text_y 80 20], 'BackgroundColor',userdata.defaultBackground);
        userdata.ADC.robot2.PT_RO_value = uicontrol('Style', 'text', 'String', 'NaN', 'Fontsize',18,...
           'Position', [text_x+text_x_value 5*text_y 80 20], 'BackgroundColor',userdata.defaultBackground);
        userdata.ADC.robot2.PT_BL_value = uicontrol('Style', 'text', 'String', 'NaN', 'Fontsize',18,...
           'Position', [text_x+text_x_value 4*text_y 80 20], 'BackgroundColor',userdata.defaultBackground);
        userdata.ADC.robot2.PT_BR_value = uicontrol('Style', 'text', 'String', 'NaN', 'Fontsize',18,...
           'Position', [text_x+text_x_value 3*text_y 80 20], 'BackgroundColor',userdata.defaultBackground);
        userdata.ADC.robot2.PT_PUCK_value = uicontrol('Style', 'text', 'String', 'NaN', 'Fontsize',18,...
